...
public class Modle implements Parcelable {
    ...
    public Modle(String addrId, String detailAddr, boolean selected) {
        this.addrId = addrId;
    ...
    public static final Creator<Modle> CREATOR = new Creator<Modle>() {
        @Override
        public Modle createFromParcel(Parcel source) {return new Modle(source);}

        @Override
        public Modle[] newArray(int size) {return new Modle[size];}
    };
